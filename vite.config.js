...
export default defineConfig(({ command, mode }) => {
  ...
  */
  const {
    ...
    DASHBOARD_TOKEN_SALE_ADDRESS,
    DASHBOARD_GNO_TOKEN_ADDRESS,
      ...
      inject: {
        data: {
          ...
          injectOgTags:
            ...
            <meta property="og:title" content="리뉴독 Admin">
            <meta property="og:description" content="리뉴독 Admin">
            <meta property="og:image" content="${base}og.png">
            <meta name="twitter:card" content="summary_large_image">
            <meta name="twitter:title" content="리뉴독 Admin">
            <meta name="twitter:description" content="리뉴독 Admin">
            <meta name="twitter:image" content="${base}og.png">
            <meta property="og:url" content="https://admin.humanwellness.kr">
            <meta property="twitter:domain" content="admin.humanwellness.kr">
            <meta property="twitter:url" content="https://admin.humanwellness.kr">
          `,
        },
        BLOCKCHAIN_EXPLORER_URL,
        DASHBOARD_THIRDWEB_CLIENT_ID,
