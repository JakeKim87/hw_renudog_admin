...
export const orderPartialCancelMutation = gql`
  mutation OrderPartialCancel(
    $id: ID!
    $lines: [OrderLineCancelInput!]!
    $refundBankCode: String
    $refundAccountNumber: String
    $refundHolderName: String
  ) {
...
`;
export const orderFulfillmentUpdateDeliveryStatus = gql`
  mutation OrderFulfillmentUpdateDeliveryStatus($id: ID!, $deliveryStatus: DeliveryStatus!) {
    orderFulfillmentUpdateDeliveryStatus(id: $id, deliveryStatus: $deliveryStatus) {
      errors {
        field
        message
      }
...
`;
export const orderComplete = gql`
  mutation OrderComplete($id: ID!) {
    orderComplete(id: $id) {
      order {
        id
        number
...
export const orderExchangeUpdateStatus = gql`
  mutation OrderExchangeUpdateStatus(
    $id: ID!
    $status: OrderExchangeStatusEnum!
    $adminNote: String
  ) {
    orderExchangeRequestUpdate(id: $id, input: { status: $status, adminNote: $adminNote }) {
      orderExchange {
        id
        status
        adminNote
...
export const orderBonusLinesCreateMutation = gql`
  mutation OrderBonusLinesCreate($id: ID!, $input: [BonusOrderLineCreateInput!]!) {
    orderBonusLinesCreate(id: $id, input: $input) {
      errors {
        ...OrderError
      }
      order {
