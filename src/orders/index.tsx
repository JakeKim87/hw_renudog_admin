...
import {
  deliveredOrderListPath,
  inTransitOrderListPath,
  orderDraftListPath,
  ...
  OrderUrlQueryParams,
  preparingOrderListPath,
  unfulfilledOrderListPath,
} from "./urls";
import DeliveredOrderListComponent from "./views/DeliveredOrderList";
import InTransitOrderListComponent from "./views/InTransitOrderList";
...
import PreparingOrderListComponent from "./views/PreparingOrderList";
import UnfulfilledOrderListComponent from "./views/UnfulfilledOrderList";
...
const UnfulfilledOrderList: React.FC<RouteComponentProps<any>> = ({ location }) => {
  const qs = parseQs(location.search.substr(1)) as any;
  const params: OrderListUrlQueryParams = asSortParams(
    qs,
    OrderListUrlSortField,
  ...
  return (
    <ConditionalOrderFilterProvider locationSearch={location.search}>
      <UnfulfilledOrderListComponent params={params} />
    </ConditionalOrderFilterProvider>
  );
};

const PreparingOrderList: React.FC<RouteComponentProps<any>> = ({ location }) => {
  const qs = parseQs(location.search.substr(1)) as any;
  const params: OrderListUrlQueryParams = asSortParams(
    qs,
    OrderListUrlSortField,
  ...
  return (
    <ConditionalOrderFilterProvider locationSearch={location.search}>
      <PreparingOrderListComponent params={params} />
    </ConditionalOrderFilterProvider>
  );
};
const InTransitOrderList: React.FC<RouteComponentProps<any>> = ({ location }) => {
  const qs = parseQs(location.search.substr(1)) as any;
  const params: OrderListUrlQueryParams = asSortParams(
    qs,
    OrderListUrlSortField,
  ...
  return (
    <ConditionalOrderFilterProvider locationSearch={location.search}>
      <InTransitOrderListComponent params={params} />
    </ConditionalOrderFilterProvider>
  );
};

const DeliveredOrderList: React.FC<RouteComponentProps<any>> = ({ location }) => {
  const qs = parseQs(location.search.substr(1)) as any;
  const params: OrderListUrlQueryParams = asSortParams(
    qs,
    OrderListUrlSortField,
  ...
  return (
    <ConditionalOrderFilterProvider locationSearch={location.search}>
      <DeliveredOrderListComponent params={params} />
    </ConditionalOrderFilterProvider>
  );
};
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route exact path={unfulfilledOrderListPath} component={UnfulfilledOrderList} />
        <Route exact path={preparingOrderListPath} component={PreparingOrderList} />
        <Route exact path={inTransitOrderListPath} component={InTransitOrderList} />
        <Route exact path={deliveredOrderListPath} component={DeliveredOrderList} />
