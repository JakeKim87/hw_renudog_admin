...
export const ProductCreatePage: React.FC<ProductCreatePageProps> = ({
  ...
  const [selectedTaxClass, setSelectedTaxClass] = useState(initial?.taxClassId ?? "");
  ...
  const augmentedInitial = {
    rewardPointRate: 0, // 개별 적립률 기본값은 0
    useChannelDefaultRate: true, // 채널 기본값 사용을 기본으로 설정
    ...initial, // 외부에서 받은 initial 값으로 덮어씁니다.
  };
          ...
          <DetailPageLayout>
            ...
            <DetailPageLayout.RightSidebar>
              ...
              <ProductVisibility
                ...
                errors={errors} // 적절한 에러 prop 전달
                membershipTiers={tiersData?.membershipTiers ?? []}
                onChange={change}
              />
              {/* {isSimpleProduct ? (
