...
import SearchInput from "@dashboard/components/SearchBar/SearchInput";
    ...
    <ListPageLayout>
      ...
      <DashboardCard>
        <Box
          ...
          paddingY={4}
          display="grid"
          __gridTemplateColumns="1fr auto" // 왼쪽(검색창)은 남는 공간 모두, 오른쪽(액션)은 컨텐츠 크기만큼
          gap={4}
          alignItems="center"
        >
          {/* 왼쪽: 검색창 */}
