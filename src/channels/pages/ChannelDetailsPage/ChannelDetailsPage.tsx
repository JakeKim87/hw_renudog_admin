...
const ChannelDetailsPage = function <TErrors extends ChannelErrorFragment[]>({
  ...
  const initialData: FormData = {
    ...
    defaultRewardPointRate: defaultRewardPointRate ?? 0,
    ...
    paymentInfo: channel?.paymentInfo || "",
    deliveryInfo: channel?.deliveryInfo || "",
    exchangeInfo: channel?.exchangeInfo || "",
  };
