...
export const ConditionalVoucherFilterProvider: FC<{ locationSearch: string; children?: ReactNode; }> = ({
  children,
  locationSearch,
}) => {
...
export const ConditionalGiftCardsFilterProver: FC<{ locationSearch: string; children?: ReactNode }> = ({
  children,
  locationSearch,
}) => {
