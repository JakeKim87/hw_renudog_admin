...
export const Datagrid: React.FC<DatagridProps> = ({
  ...
  const handleGetCellContent = useCallback(
    ...
    [changes, added, removed, getChangeIndex, availableColumns, getCellContent, areCellsDirty, theme, getCellError, themeValues.colors.background.critical1],
  );
  ...
  const handleCellClick = useCallback(
    ...
    [rowMarkers, onRowClick, availableColumns, handleRowHover, rowAnchorRef],
  );
