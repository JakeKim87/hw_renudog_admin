...
// [변경] Datagrid 임포트
import { DepositHistoryListDatagrid } from "../depositHistoryListDatagrid";
...
const useStyles = makeStyles(
  ...
  { name: "DepositHistoryListPage" }, // [변경] 스타일 이름
);
...
export const DepositHistoryListPage = ({
  data,
  disabled,
  settings,
  ...
  return (
    <ListPageLayout>
      ...
      <DashboardCard>
          ...
          <div className={classes.filterGroup}>
            ...
            >
              ...
              >
                ...
                <MenuItem value="DEBIT">차감</MenuItem>
              </Select>
            </FormControl>
          </div>
          ...
          <div className={classes.searchGroup}>
            <div className={classes.filterGroup} style={{ flex: 1 }}>
              ...
              <Input
                ...
                placeholder="병원명, 이메일, 사유, 주문번호 검색"
                fullWidth
              />
            </div>
          </div>
        ...
        {/* [변경] DepositHistoryListDatagrid 사용 */}
        <DepositHistoryListDatagrid
          disabled={disabled}
          settings={settings}
