...
export enum ListViews {
  ...
  FAQ_LIST = "FAQ_LIST",
  MEMBERSHIP_TIER_LIST = "MEMBERSHIP_TIER_LIST",
  NOTICE_LIST = "NOTICE_LIST",
  SALES_REPRESENTATIVE_LIST = "salesRepresentativeList",
  STOCK_LIST = "STOCK_LIST",
  POPUP_LIST = "POPUP_LIST",
  EVENT_LIST = "EVENT_LIST",
  EVENT_SUBMISSION_LIST = "EVENT_SUBMISSION_LIST",
  POINT_HISTORY_LIST = "POINT_HISTORY_LIST",
  DEPOSIT_HISTORY_LIST = "DEPOSIT_HISTORY_LIST",
  AGENCY_TRANSFER_LIST = "AGENCY_TRANSFER_LIST",
}
