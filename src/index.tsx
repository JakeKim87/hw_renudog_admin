...
import DepositHistorySection from "./depositHistory";
import DiscountSection from "./discounts";
import EventSection from "./events";
import { eventListPath, eventSubmissionListPath } from "./events/urls";
...
import MembershipTierSection from "./membershipTiers";
...
import PointHistorySection from "./pointHistory";
import PopupSection from "./popups";
import { popupListPath } from "./popups/urls";
import ProductSection from "./products";
import ProductTypesSection from "./productTypes";
import SalesRepresentativeSection from "./salesRepresentatives";
...
import TokenSaleSection from "./tokenSale";
import { tokenSalePath } from "./tokenSale/urls";
import TranslationsSection from "./translations";
import WarehouseSection from "./warehouses";
import { inventoryListPath, warehouseSection } from "./warehouses/urls";
            ...
            >
              <Switch>
                ...
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_USERS]}
                  path="/point-history"
                  component={PointHistorySection}
                />
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_USERS]}
                  path="/deposit-history"
                  component={DepositHistorySection}
                />
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_PAGES]}
                  path={[eventListPath, eventSubmissionListPath]}
                ...
                <SectionRoute
                  ...
                  component={MembershipTierSection}
                />
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_USERS]}
                  path="/sales-representatives"
                  component={SalesRepresentativeSection}
                />
                <SectionRoute
                ...
                />
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_ORDERS]} // 관리자만 접근 가능
                  path={[
                    pendingAgencyTransfersPath,
                    processedAgencyTransfersPath,
                    agencyTransferDetailsPath(":id"),
                  ]}
                  component={AgencyTransfersSection}
                />
                <SectionRoute
                  permissions={[PermissionEnum.MANAGE_PRODUCTS]}
                  path="/products"
